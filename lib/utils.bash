...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for trufflehog.
...
download_release() {
	...
	# TODO: Adapt the release URL convention for trufflehog
...
install_version() {
	...
	(
		...
		# TODO: Assert trufflehog executable exists.
		local tool_cmd
